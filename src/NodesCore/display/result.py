...
class OutputModule:
    ...
    def run(self, path):
        ...
        try:
            with dpg.node(parent="MainNodeEditor", tag="Node_Modified_image", label="Result image", pos=[10, 10]):
            ...
            with dpg.popup("Node_Modified_image"):
                dpg.add_button(label="Delete", callback=lambda: dpg.delete_item("Node_Modified_image"))
